...
map.getView().fit([2372214.092363, -2618248.520047, 4311750.974556, -1664568.065574], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">2024 Post treatment survey district crop yields</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (126 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Map showing the crop yields for White Sorgum, Pearl Millet, Cow Peas, Velvet Beans and Sesame per district in tonnes/ha (2024)';
            }
